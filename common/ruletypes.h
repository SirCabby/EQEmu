...
RULE_INT(Character, ResurrectionHealthPercent, 35, "AKK-STACK: percent of max HP a player is restored to when they accept a resurrection. Stock was 20 with rez effects / 5 without. A full-heal rez (Divine Resurrection) is unaffected.")
...
RULE_BOOL(Client, RcpBroadcastHealth, false, "rof2ClientPlus: send mob health-percent updates to every nearby client, not just those targeting the mob (nameplate health bars)")
