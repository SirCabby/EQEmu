...
public:
	...
	bool AdvLoreBlocked(Client *c, uint32 adv_uid);     // akk-stack advanced looting: would delivering this drop to the player hit a lore conflict? (pre-check so Give can tell the sender why)
